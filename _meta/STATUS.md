...
**Terakhir di-update:** `2026-07-19` · **oleh device:** `Victus (Windows)` · **oleh:** 07 Food Scan App (Fareynaldi) — **DITOLAK → DIPERBAIKI & re-verified.** Build gagal di Flutter terbaru krn `tflite_flutter` usang (Java 8 vs Kotlin 21) → fix: `flutter upgrade` 3.44.6/Dart 3.12.2 + ganti ke `flutter_litert`. Build APK LOLOS + inferensi terverifikasi di emulator. Zip 18.83 MB siap RE-SUBMIT
...
- **Total:** 23 folder pengerjaan (9 course, 4 anggota) — +1: `06 RootFacts (Dafina)` dibuat 2026-07-19.
...
| 06 | penerapan-ai-aplikasi-web | RootFacts PWA (flan-t5-base) — **Dafina** | 📤 | target ⭐⭐⭐ (Basic) | 🍎 | **Deploy live + zip siap** (Netlify verified). Tinggal user **UPLOAD zip ke Dicoding** |
